...
export const pricingHero = {
  ...
  subheadline: "Choose the right level of support based on where your business is today. From understanding opportunities to building customer acquisition systems, we help businesses grow with clarity.",
...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    price: "$300+",
    features: ["Everything in Growth Audit", "Business direction review", "Customer journey improvements", "Google Analytics setup", "Google Search Console setup", "Meta Business Manager setup", "Meta Pixel setup", "Conversion tracking setup", "Digital presence improvements"],
  ...
  },
  {
    ...
    price: "Custom",
    features: ["Everything in Growth Accelerator", "Brand strategy", "Brand positioning", "Visual identity", "Logo development", "Website design and development", "Sales funnels", "Automation systems", "CRM setup", "Growth strategy sessions", "Continuous optimisation"],
    ctaLabel: "Become a Growth Partner",
  },
];

export const pricingDisclaimer = "All packages start from the prices shown. Final investment depends on your business goals, requirements, and the growth systems needed to achieve your objectives.";
