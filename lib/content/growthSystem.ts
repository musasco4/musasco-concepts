...
export const growthOverview = {
  ...
  stages: [
    { id: "attract", label: "Attract", description: "Creates demand and brings the right people into the business." },
    { id: "convert", label: "Convert", description: "Turns attention and traffic into qualified opportunities and customers." },
    { id: "scale", label: "Scale", description: "Makes what works measurable, repeatable, and increasingly efficient." },
  ],
};
...
export const growthEngines: Record<string, EngineStage> = {
  attract: {
    ...
    capabilities: ["Meta Ads Management", "Google Ads Management", "Audience Targeting", "Demand Generation", "Search Visibility"],
  },
  convert: {
    id: "convert",
    name: "Convert",
    ...
    capabilities: ["Landing Page Design", "Website Experience", "Conversion Optimisation", "Customer Journey Mapping", "Lead Capture Systems"],
  },
  scale: {
    id: "scale",
    name: "Scale",
    ...
    capabilities: ["Analytics & Tracking", "Performance Reporting", "Marketing Automation", "Growth Strategy", "Continuous Optimisation"],
  },
};
...
export const growthProcess = {
  ...
  steps: [
    { step: 1, name: "Audit", description: "We identify where your current system is leaking value." },
    { step: 2, name: "Blueprint", description: "We design the specific infrastructure required to fix it." },
    { step: 3, name: "Build", description: "We implement the systems across Attract, Convert, and Scale." },
    { step: 4, name: "Optimise", description: "We measure, refine, and compound the results over time." },
  ],
};
